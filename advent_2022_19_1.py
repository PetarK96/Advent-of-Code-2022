...
for blueprint in blueprints:
    ...
    if len(blueprints.keys()) > 5 and blueprint in [1, 4, 7, 9, 11, 13, 23, 28, 29]:
        pass
    else:
    ...
    while frontier:
        ...
        max_obsidian_needed = (max_obsidian_cost * max_builds_left) - (robots[1] * (max_builds_left - 1))
    ...
    quality_level += ((blueprint + 1) * best_score)
